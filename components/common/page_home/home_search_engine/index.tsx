...
export default function Home_Search_Engine(){
    ...
    useEffect(() => {
        ...
        setReturnInfo(
            `Recogida del vehiculo: ${formattedPickup} | Devolución: ${formattedReturn} - ${returnHour}:00`
        );
            ...
            <section className="w-full flex flex-col bg-neutral-100 p-10 md:p-20 gap-4">
                ...
                <section className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex flex-col w-full text-xs">
                        ...
                        <input
                            ...
                            type="text"
                            placeholder="Bogotá Aeropuerto / Colombia"
                ...
                <div className="flex w-full text-xs">
                    <p className="text-neutral-500 py-4">
                        {returnInfo || "Devolución del Vehículo"}
                    </p>
                </div>
