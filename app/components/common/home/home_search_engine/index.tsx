'use client'
import { FiArrowRight, FiCalendar, FiCheck, FiClock, FiLayers, FiMap } from "react-icons/fi";
...
export default function SearchEngine(){
    ...
    return(
        <section className="w-full max-w-7xl gap-2 h-auto flex flex-row-reverse justify-center items-center font-thin text-neutral-800">
                <section className="w-full h-auto flex flex-col justify-center items-center bg-neutral-100 p-10">
                    <>
