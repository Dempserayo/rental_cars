...
import { handleReserve } from "@/src/lib/reservationUtils";
import { selectVehicle } from "@/src/store/vehicleSlice";
        ...
        <div className="w-full h-full flex flex-col justify-between text-[10px] md:text-xs gap-4 p-10">
          ...
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
            ...
            <span className="md:p-4">
              ...
              <p>{t("search.card.rateFor4Days")} {totalPrice.toLocaleString()}</p>
            </span>
            ...
            <span className="flex flex-row gap-2">
              ...
              >
                {isReserved ? t("search.card.cancel") : t("search.card.reserve")}
